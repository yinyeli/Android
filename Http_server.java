    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendRequestWithHttpURLConnection("https://www.baidu.com");//注意，此处不能输入：www.baidu.com。必须是全连接
            }
        });
    }
...
//                }
//                else {
//                    Toast.makeText(MainActivity.this,"登录失败："+responseStr,Toast.LENGTH_LONG).show();
//                }
            }
        });
    }
