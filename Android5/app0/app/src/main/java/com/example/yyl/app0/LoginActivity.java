...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnqqlogin = (Button)findViewById(R.id.buttonQQlogin);
...
//                Toast.makeText(LoginActivity.this,"running ",Toast.LENGTH_SHORT).show();
            ...
            case R.id.buttonQQlogin:
                //跳转QQ登录页面
//                Toast.makeText(LoginActivity.this,"in qq login ",Toast.LENGTH_SHORT).show();
                Intent intent2 = new Intent(LoginActivity.this, activity_qqlogin.class);
